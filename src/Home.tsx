...
import { MintCountdown, useStyles } from './MintCountdown';
...
const Home = (props: HomeProps) => {
  ...
  const refreshCandyMachineState = useCallback(
    async (commitment: Commitment = 'confirmed') => {
      ...
      const balanceUser = await UpdateBalance( wallet, connection);
      setUserSolBalance(balanceUser || 0);
                ...
                >
                  ...
                  <Grid item xs={12}>
                    {isActive && endDate && Date.now() < endDate.getTime() ? (
                      <>
                        <span className={classes.done}>{'TO END OF MINT'}</span>
                        <MintCountdown
                          key="endSettings"
